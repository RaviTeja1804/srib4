    ...
    private fun generateImageFromAI(onComplete: (base64: String?, prompt: String) -> Unit) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                val geminiPrompt = "Give me a short, descriptive prompt (max 10 words ONLY) for a festival celebrated mainly in India or general festival worldwide during the month of $monthName."
